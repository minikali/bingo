  ...
  return (
    <LegalPage title="Disclaimer">
      ...
      <p>
        ...
        purposes only. The information is provided by [website name] and while
      ...
      <p>
        ...
        not under the control of [website name]. We have no control over the
      ...
      <p>
        ...
        However, [website name] takes no responsibility for, and will not be
